      ...
      <BSNavbar fixedTop collapseOnSelect className="navbar-main">
        <Grid className="grid">
          <Row className="show-grid">
            {this.props.user && <Col xs={4} className="col-left">
              <Popup
              ...
              >
                <form className="form-style">
                  <div className="row">
                    <div className="col">
                      <input type="text" id="imgUrl" className="form-control input-style" placeholder="Image Url" autoFocus required />
                    </div>
                    <div className="col">
                      <input
                        type="text"
            ...
            <Col xs={4} className="col-right">
              ...
              >
                {this.props.user && <p className="logout-nav disable-select ">Logout</p>}
              </a>
            </Col>
          </Row>
        </Grid>
