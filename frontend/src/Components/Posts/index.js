    ...
    return (
      ...
      <Grid>
        <Row className="show-grid">
          {this.props.posts.length && <Profile newest={this.props.posts[0].createdAt} count={this.props.posts.length} name={this.props.posts[0].username} userClick={this.props.userClick} />}
